...
Public Class LoginPage
    ...
    Sub login()
        ...
        If dt.Rows.Count = 0 Then
            ...
            eTxtNofif.InnerHtml = "User/JDE " + eusername + " is Not Registered"
        Else
            ...
            For Each row As DataRow In dt.Select()
                ...
                If (row("ActiveStatus")) = 0 Then
                    eNotif.Style.Add("display", "Block")
                    eTxtNofif.InnerHtml = "User/JDE " + eusername + " No Longer Active"
                ElseIf ePass <> currpass Then
                    eNotif.Style.Add("display", "Block")
                    eTxtNofif.InnerHtml = "Password did not Match"
                Else
