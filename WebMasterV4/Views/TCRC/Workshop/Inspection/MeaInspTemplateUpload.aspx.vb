...
Public Class MeaInspTemplateUpload
    ...
    Protected Sub bDownloadTemp_Click(sender As Object, e As EventArgs)
        Dim fileToDownload = Server.MapPath("~/Files/Digital Inspection Template.xlsx")
    ...
    Protected Sub bUpload_Click(sender As Object, e As EventArgs)
        Dim idgp As String = Request.QueryString("id")
        Dim eby As String = Session("ss_username")

        If idgp = String.Empty Then
            Exit Sub
        End If

        If eby = String.Empty Then
            Exit Sub
        End If
        ...
        Try
            ...
            Do Until EOF(filenum)
                ...
                Else
                    ...
                    Dim tempstring = "exec dbo.InspUploadTemplate " & idgp & "," & esectionname & "," & esubsectionname _
                                    & "," & eitemdesc & "," & eloopcount & "," & evaltype & "," & eSeqSection & "," & eSeqSubSection _
                                    & "," & eSeqItem & "," & Utility.evar(eby, 1)
...
skipp:
            ...
            'showtoast(Page, "File Upload Success !", "Notification", "success", False, "toast-bottom-full-width", False)
            lsuccess.Text = "File Upload Success !"
            'load_Section()
        Catch ex As Exception
            'showtoast(Page, ex.Message, "Error Notification", "warning", False, "toast-bottom-full-width", False)
        End Try
    End Sub
End Class